...
namespace pharmSoft
{
    public partial class users : Form
    {
        ...
        public users()
        {
            ...
            CboUsers.Items.Add("Pharmacist");
            CboUsers.Items.Add("Receptionist");
            CboUsers.Items.Add("Doctor");
        }
        ...
        private void lbtnStock_Save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    myconn1.Open();
                    string Query1 = "insert into users(fname,othername,idno,email,telno,gender,role,username,password,dateofregistration) values('" + txtfname.Text + "','" + txtothername.Text + "','" + Convert.ToInt64(txtnid.Text) + "','" + txtaddress.Text + "','" + txttelephone.Text + "','" + gender() + "','" + CboUsers.SelectedItem + "','" + txtusername.Text + "','" + passresult + "','" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "')";
